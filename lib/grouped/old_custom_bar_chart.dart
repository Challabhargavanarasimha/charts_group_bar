...
class OldCustomBarChart<T> extends StatefulWidget {
  OldCustomBarChart({
  ...
  @override
  State<OldCustomBarChart<T>> createState() => _OldCustomBarChartState<T>();
}

class _OldCustomBarChartState<T> extends State<OldCustomBarChart<T>> {
